...
export const SEED_FOODS: SeedFood[] = [
  ...
  { slug: 'pechuga-pollo-cocida', name: 'Pechuga de pollo (cocida)', refAmount: 100, refUnit: 'g',
    kcal: 165, proteinG: 31, carbsG: 0, fatG: 3.6, fiberG: 0,
    portions: [{ label: 'porcion', amount: 110 }],
    source: 'USDA SR Legacy #171477 - Chicken, broilers or fryers, breast, meat only, cooked, roasted | 150 g crudos rinden ~110 g cocidos' },
